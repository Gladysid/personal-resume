...
#contact {
    width: 100%;
    height:710px;
    background: url('../assets/last-pic-2.jpg') no-repeat center 0px;
...
.title{padding:6px 0 10px;font-family: 'Overlock', cursive;color: #2F2C06;font-size: 36px;margin-top: 0; }
